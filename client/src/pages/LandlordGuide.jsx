...
const ShareButton = ({ section, title, description }) => {
  ...
  return (
    <ShareMenu
      title={title}
      text={shareText}
      headerLabel={`${t('landlord_guide.share')} ${section}`}
      buttonLabel={t('landlord_guide.share')}
      copySuccessMessage={t('landlord_guide.share_copied')}
      copyErrorMessage={t('landlord_guide.share_copy_error')}
    />
  );
};
