                        ...
                        to={
                          user?.user_type === 'tenant'
                            ...
                            : user?.user_type === 'super_admin'
                              ? '/super-admin'
                            : user?.user_type === 'super_support_admin'
                              ? '/admin/super-support-dashboard'
                              : user?.user_type === 'state_support_admin'
                                ? '/admin/state-support-dashboard'
                            : user?.user_type === 'state_admin' || user?.user_type === 'state_financial_admin'
                              ? '/admin'
                            ...
                            : user?.user_type === 'lawyer'
                              ? '/lawyer'
                              : user?.user_type === 'state_lawyer'
                                ? '/lawyer/state'
                                : user?.user_type === 'super_lawyer'
                                  ? '/lawyer/super'
