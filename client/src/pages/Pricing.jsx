...
const ShareButton = ({ section, title, description }) => {
  ...
  return (
    <ShareMenu
      title={title}
      text={shareText}
      headerLabel={t('pricing.share_section', { section })}
      buttonLabel={t('pricing.share')}
      copySuccessMessage={t('pricing.toast_copied')}
      copyErrorMessage={t('pricing.toast_copy_failed')}
    />
  );
};
