    ...
    <div className="min-h-screen bg-gray-50">
      <div className="mx-auto max-w-7xl space-y-6 px-4 py-8">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="min-w-0 flex-1">
              <p className="text-xs font-medium uppercase tracking-widest text-indigo-200">Agent Workspace</p>
        ...
        {!assignment ? (
          ...
          <>
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
              <StatCard icon={<FaHome />} label="Assigned State" value={profile?.assigned_state || 'Not configured'} />
              <StatCard icon={<FaClipboardList />} label="Landlord" value={assignment.landlord_name} />
              <StatCard icon={<FaShieldAlt />} label="Assignment Status" value={assignment.status || 'Active'} />
            ...
            <div className="agent-commissions-section rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-gray-500">
                    ...
                    <br />Agents are state-locked and can only operate in their assigned state.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-4 flex items-center gap-3">
                ...
                {migrationRequests.length > 0 && (
                  <span className="text-xs text-gray-400">{migrationRequests.length} request{migrationRequests.length !== 1 ? 's' : ''} submitted</span>
                )}
              </div>

              {migrationRequests.length > 0 && (
                <div className="mt-5 space-y-2">
                  <p className="text-xs font-medium uppercase tracking-wide text-gray-500">Recent requests</p>
                ...
                <div className="agent-bookings-section rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div className="rounded-xl border border-gray-100 bg-gray-50 p-4">
                      <p className="text-xs font-medium uppercase tracking-wide text-gray-500">Landlord</p>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                ...
                <PermissionBadge enabled={assignment.can_manage_damage_reports} label="Property maintenance assessments" />
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                <QuickActionLink to="/my-properties" icon={<FaHome />} label="Managed Properties" description="View and manage assigned properties" />
                <QuickActionLink to="/add-property" icon={<FaBuilding />} label="Maintenance Assessments" description="Property maintenance assessment tasks" />
                <QuickActionLink to="/messages" icon={<FaCommentDots />} label="Dispute & Evidence" description="Dispute and evidence tasks" />
                <QuickActionLink to="/messages" icon={<FaGavel />} label="Legal Messages" description="Legal and dispute messages" />
                <QuickActionLink to="/agent/earnings" icon={<FaCoins />} label="Commission Ledger" description="Commission ledger and earnings" />
                <QuickActionLink to="/agent/withdrawals" icon={<FaMoneyBillWave />} label="Withdrawals" description="Withdrawal request flow" />
              </div>
            </div>
          </>
        )}
