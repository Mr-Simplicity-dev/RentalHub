...
export const TOUR_STEPS = {
  ...
  LANDLORD_DASHBOARD: [
    ...
    {
      id: 'landlord_withdrawal_notice',
      target: '.tour-landlord-withdrawal-notice',
      title: 'Rent Payment Withdrawals',
      description: 'Rent payments are held for 14 working days to allow tenant refund requests to be reviewed before the funds are released for withdrawal.',
      placement: 'bottom',
      highlight: true,
      optional: true,
    },
  ...
  AGENT_DASHBOARD: [
    ...
    {
      id: 'agent_6',
      target: '.agent-task-areas-section',
      title: 'Task Areas',
      description: 'Jump into managed properties, assessments, dispute evidence, legal messages, and commission tools.',
      placement: 'top',
      highlight: true,
    },
  ],
  ...
  FINANCIAL_ADMIN_DASHBOARD: [
    ...
    {
      id: 'fin_admin_5',
      target: '.fin-admin-header-section',
      route: '/admin/financial-dashboard?tab=overview',
      title: 'Financial Actions',
      description: 'Jump to transactions, frozen funds, withdrawals, commission statements, and personal withdrawals from here.',
      placement: 'bottom',
      highlight: true,
      optional: true,
    },
    {
      id: 'fin_admin_6',
      target: '.fin-admin-audit-section',
      route: '/admin/financial-dashboard?tab=audit-trail',
      title: 'Transaction Audit Trail',
      description: 'Review the complete audit history of financial actions and account changes.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'fin_admin_7',
      target: '.fin-admin-escalations-section',
      route: '/admin/financial-dashboard?tab=support-escalations',
      title: 'Support Escalations',
      description: 'Review finance support escalations and resolve team tickets.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  STATE_ADMIN_DASHBOARD: [
    ...
    {
      id: 'state_admin_5',
      target: '.state-admin-commissions-section',
      route: '/admin?tab=commissions',
      title: 'Commission History',
      description: 'Review earned commission records and download your statement for the assigned state.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'state_admin_6',
      target: '.state-admin-transactions-section',
      route: '/admin?tab=transactions',
      title: 'All Transactions',
      description: 'Search and review every transaction connected to your state with full filters.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'state_admin_7',
      target: '.state-admin-users-section',
      route: '/admin?tab=users',
      title: 'Managed Users',
      description: 'Review the tenants, landlords, and agents operating under your assigned state.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'state_admin_8',
      target: '.state-admin-withdrawals-section',
      route: '/admin?tab=withdrawals',
      title: 'Withdrawal History',
      description: 'Track every commission withdrawal request, status, and exportable record.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'state_admin_9',
      target: '.state-admin-oversight-section',
      route: '/admin?tab=oversight',
      title: 'Local Government Oversight',
      description: 'Monitor LGA coverage, unit totals, local admins, and active coverage from this board.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  SUPER_FINANCIAL_ADMIN_DASHBOARD: [
    ...
    {
      id: 'super_fin_admin_5',
      target: '.super-financial-kpi-section',
      route: '/admin/super-financial-dashboard?panel=overview',
      title: 'National KPIs',
      description: 'Monitor today and 7-day transaction counts, volumes, and frozen-fund totals at a glance.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_fin_admin_6',
      target: '.super-financial-health-section',
      route: '/admin/super-financial-dashboard?panel=overview',
      title: 'Commission Health',
      description: 'Review global payout pressure, pending commissions, and the exportable withdrawal snapshot.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_fin_admin_7',
      target: '#super-financial-withdrawals',
      route: '/admin/super-financial-dashboard?panel=personal-withdrawals',
      title: 'Personal Withdrawals',
      description: 'Track your own withdrawal requests, destination accounts, amounts, and approval status.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_fin_admin_8',
      target: '#super-financial-frozen-funds',
      route: '/admin/super-financial-dashboard?panel=frozen-funds',
      title: 'Active Frozen Funds',
      description: 'Review funds frozen for investigation and manage the global freeze workflow.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_fin_admin_9',
      target: '#super-financial-support-escalations',
      route: '/admin/super-financial-dashboard?panel=escalations',
      title: 'Support Escalations',
      description: 'Review finance-related support escalations from across the platform.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  TRANSPORTATION_ADMIN_DASHBOARD: [
    ...
    {
      id: 'trans_admin_5',
      target: '.trans-admin-alerts-section',
      route: '/admin/transportation?tab=alerts',
      title: 'Alert Management',
      description: 'Resolve failed payments, cancellations, and critical logistics issues before they affect tenant moves.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'trans_admin_6',
      target: '.trans-admin-analytics-section',
      route: '/admin/transportation?tab=analytics',
      title: 'Analytics',
      description: 'Review revenue trends and the top tenants and properties using transportation services.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  STATE_TRANSPORTATION_ADMIN_DASHBOARD: [
    ...
    {
      id: 'state_trans_admin_5',
      target: '.state-trans-alerts-section',
      route: '/admin/transportation/state?tab=alerts',
    ...
    {
      id: 'state_trans_admin_6',
      target: '.state-trans-analytics-section',
      route: '/admin/transportation/state?tab=analytics',
      title: 'State Analytics',
      description: 'Review revenue trends and top properties within your state scope.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  SUPER_TRANSPORTATION_ADMIN_DASHBOARD: [
    ...
    {
      id: 'super_trans_admin_5',
      target: '.super-trans-metrics-section',
      route: '/super-admin/transportation?tab=metrics',
      title: 'Performance Metrics',
      description: 'Review stored transportation performance metrics used for reporting and monitoring.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  RECRUITMENT_ADMIN_DASHBOARD: [
    ...
    {
      id: 'rec_admin_4',
      target: '.recruitment-admin-roles-section',
      route: '/admin/recruitment?tab=roles',
      title: 'Roles & Fees',
      description: 'Configure recruitment roles, application fees, and their availability across cycles.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'rec_admin_5',
      target: '.recruitment-admin-locations-section',
      route: '/admin/recruitment?tab=locations',
      title: 'Locations',
      description: 'Manage the states and locations where recruitment is active.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'rec_admin_6',
      target: '.recruitment-admin-interviews-section',
      route: '/admin/recruitment?tab=interviews',
      title: 'Interviews',
      description: 'Review scheduled interviews, interview outcomes, and candidate progress.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  STATE_SUPPORT_DASHBOARD: [
    ...
    {
      id: 'state_support_4',
      target: '.state-support-tenancy-section',
      route: '/admin/state-support-dashboard?tab=tenancy',
      title: 'Tenancy Operations',
      description: 'Enable grace periods and refunds for tenants across your state.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'state_support_5',
      target: '.state-support-tickets-section',
      route: '/admin/state-support-dashboard?tab=tickets',
      title: 'Support Tickets',
      description: 'Resolve support tickets and keep conversations with users on-platform.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'state_support_6',
      target: '.state-support-escalations-section',
      route: '/admin/state-support-dashboard?tab=escalations',
      title: 'Escalations',
      description: 'Review escalated tickets that need state-level attention.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  SUPER_SUPPORT_DASHBOARD: [
    ...
    {
      id: 'super_support_5',
      target: '.super-support-alerts-section',
      route: '/admin/super-support-dashboard?tab=alerts',
      title: 'System Alerts',
      description: 'Review platform-wide warning and critical alerts, then configure alert thresholds.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_support_6',
      target: '.super-support-reports-section',
      route: '/admin/super-support-dashboard?tab=reports',
      title: 'Reports & Analytics',
      description: 'Review support metrics and generate quick or custom reports for the governance team.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_support_7',
      target: '.super-support-activity-section',
      route: '/admin/super-support-dashboard?tab=activity',
      title: 'Activity Feed',
      description: 'Follow the latest migration, ticket, and governance activity across the platform.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
    {
      id: 'super_support_8',
      target: '.super-support-pool-section',
      route: '/admin/super-support-dashboard?tab=pool',
      title: 'Admin Pool',
      description: 'Review available support administrators and manage assignment capacity.',
      placement: 'top',
      highlight: true,
      optional: true,
    },
  ...
  SUPER_ADMIN_DASHBOARD: [
    {
      id: 'super_1',
      target: '.super-admin-hero-section',
      title: 'Control Center',
      description: 'Your platform command layer — withdrawable earnings, role scope, and live moderation status at a glance.',
      placement: 'bottom',
      highlight: true,
    },
    {
