...
export const TOUR_STEPS = {
  ...
  TENANT_DASHBOARD: [
    {
      id: 'tenant_1',
      target: '.dashboard-properties-section',
      title: 'Your Properties',
      description: 'View and manage all your rental properties in one place. Click to see details, edit, or manage bookings.',
      placement: 'right',
      highlight: true,
    },
    {
      id: 'tenant_2',
      target: '.dashboard-bookings-section',
      title: 'Manage Bookings',
      description: 'Track all your current and past bookings. Check payment status and communicate with guests.',
      placement: 'left',
      highlight: true,
    },
    {
      id: 'tenant_3',
      target: '.dashboard-earnings-section',
      title: 'View Earnings',
      description: 'Monitor your rental income and payments. Get detailed financial reports and transaction history.',
      placement: 'left',
      highlight: true,
    },
    {
      id: 'tenant_4',
      target: '.dashboard-analytics-section',
      title: 'Analytics & Reports',
      description: 'View detailed analytics about your properties, occupancy rates, and performance metrics.',
      placement: 'top',
      highlight: true,
    },
    {
      id: 'tenant_5',
      target: '.dashboard-messages-section',
      title: 'Messages',
      description: 'Communicate directly with tenants and manage inquiries about your properties.',
      placement: 'left',
      highlight: true,
    },
  ],
...
export const getTourStepsByUserRole = (userRole) => {
  const roleToTourMap = {
    ...
    landlord: TOUR_STEPS.TENANT_DASHBOARD,
