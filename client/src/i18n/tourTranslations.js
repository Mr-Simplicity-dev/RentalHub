...
const common = {
  en: {
    ui: { dialog_label: '{{title}} guided tour', eyebrow: 'RentalHub guided tour', close_and_skip: 'Close and skip the guided tour', finding_target: 'Finding this control on the dashboard…', not_available_for_account: 'This step is not available for this account.', target_not_available: 'This dashboard section is not available yet.', target_not_available_body: 'It may still be loading or unavailable for this account. Retry, or continue without interrupting the tour.', retry_target: 'Retry target', finish_tour: 'Finish tour', skip_step: 'Skip this step', interact_hint: 'Use the highlighted control to continue automatically.', use_highlighted_control: 'Use highlighted control', step_progress: 'Step {{current}} of {{total}}', back: 'Back', next: 'Next', finish: 'Finish', skip_complete: 'Skip the complete tour', searching_sr: 'Searching for the dashboard control.', unavailable_sr: 'The dashboard control is currently unavailable.', rentalhub_dashboard: 'RentalHub dashboard' },
  ...
  ru: {
    ui: { dialog_label: 'Интерактивный тур «{{title}}»', eyebrow: 'Интерактивный тур RentalHub', close_and_skip: 'Закрыть и пропустить тур', finding_target: 'Поиск элемента управления…', not_available_for_account: 'Этот шаг недоступен для данного аккаунта.', target_not_available: 'Этот раздел пока недоступен.', target_not_available_body: 'Он может загружаться или быть недоступен аккаунту. Повторите попытку или продолжите тур.', retry_target: 'Повторить', finish_tour: 'Завершить тур', skip_step: 'Пропустить шаг', interact_hint: 'Используйте выделенный элемент, чтобы продолжить автоматически.', use_highlighted_control: 'Использовать выделенный элемент', step_progress: 'Шаг {{current}} из {{total}}', back: 'Назад', next: 'Далее', finish: 'Готово', skip_complete: 'Пропустить весь тур', searching_sr: 'Поиск элемента управления.', unavailable_sr: 'Элемент управления недоступен.', rentalhub_dashboard: 'Панель RentalHub' },
  ...
  zh: {
    ui: { dialog_label: '{{title}} 引导', eyebrow: 'RentalHub 引导', close_and_skip: '关闭并跳过引导', finding_target: '正在查找此控件…', not_available_for_account: '此步骤不适用于该账户。', target_not_available: '此控制台区域尚不可用。', target_not_available_body: '它可能仍在加载或不适用于该账户。请重试或继续引导。', retry_target: '重试目标', finish_tour: '完成引导', skip_step: '跳过此步骤', interact_hint: '使用高亮控件即可自动继续。', use_highlighted_control: '使用高亮控件', step_progress: '第 {{current}} 步，共 {{total}} 步', back: '返回', next: '下一步', finish: '完成', skip_complete: '跳过整个引导', searching_sr: '正在查找控制台控件。', unavailable_sr: '控制台控件当前不可用。', rentalhub_dashboard: 'RentalHub 控制台' },
...
const tourTranslations = Object.fromEntries(['en', 'fr', 'ar', 'ru', 'zh', 'ha', 'yo', 'ig'].map((locale) => [locale, {
  ...
  ui: {
    ...
    dialog_label: common[locale].ui.dialog_label,
    use_highlighted_control: common[locale].ui.use_highlighted_control,
