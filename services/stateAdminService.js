...
exports.createStateAdmin = async (req, res) => {
  try {
    ...
    req.logger.error('Create state admin error:', error);
    res.status(500).json({
      success: false,
...
exports.getAllStateAdmins = async (req, res) => {
  try {
    ...
    req.logger.error('Get state admins error:', error);
    res.status(500).json({
      success: false,
...
exports.manageAdminFunds = async (req, res) => {
  try {
    ...
    req.logger.error('Manage admin funds error:', error);
    res.status(500).json({
      success: false,
...
exports.updateCommissionRate = async (req, res) => {
  try {
    ...
    req.logger.error('Update commission rate error:', error);
    res.status(500).json({
      success: false,
...
exports.getStateAdminDashboard = async (req, res) => {
  try {
    ...
    req.logger.error('Get state admin dashboard error:', error);
    res.status(500).json({
      success: false,
...
exports.createSuperFinancialAdmin = async (req, res) => {
  try {
    ...
    req.logger.error('Create super financial admin error:', error);
