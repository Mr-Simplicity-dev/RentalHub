...
exports.getActiveCycles = async (req, res) => {
  try {
    ...
    req.logger.error('getActiveCycles error:', err);
...
exports.getActiveRoles = async (req, res) => {
  try {
    ...
    req.logger.error('getActiveRoles error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getStates = async (req, res) => {
  try {
    ...
    req.logger.error('getStates error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getLGAs = async (req, res) => {
  try {
    ...
    req.logger.error('getLGAs error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.verifyAccessCode = async (req, res) => {
  try {
    ...
    req.logger.error('verifyAccessCode error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.submitApplication = async (req, res) => {
  try {
    ...
    req.logger.error('submitApplication error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.downloadDocument = async (req, res) => {
  try {
    ...
    req.logger.error('downloadDocument error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.downloadMyDocumentsZip = async (req, res) => {
  try {
    ...
    req.logger.error('downloadMyDocumentsZip error:', err);
...
exports.generatePlatformCv = async (req, res) => {
  try {
    ...
    req.logger.error('generatePlatformCv error:', err);
...
exports.startInterview = async (req, res) => {
  try {
    ...
    req.logger.error('startInterview error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.submitAnswer = async (req, res) => {
  try {
    ...
    req.logger.error('submitAnswer error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.reportViolation = async (req, res) => {
  try {
    ...
    req.logger.error('reportViolation error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.interviewPing = async (req, res) => {
  try {
    ...
    req.logger.error('interviewPing error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.completeInterview = async (req, res) => {
  try {
    ...
    req.logger.error('completeInterview error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.createCycle = async (req, res) => {
  try {
    ...
    req.logger.error('createCycle error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.updateCycle = async (req, res) => {
  try {
    ...
    req.logger.error('updateCycle error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getAllCycles = async (req, res) => {
  try {
    ...
    req.logger.error('getAllCycles error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.deleteCycle = async (req, res) => {
  try {
    ...
    req.logger.error('deleteCycle error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.createRole = async (req, res) => {
  try {
    ...
    req.logger.error('createRole error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.updateRole = async (req, res) => {
  try {
    ...
    req.logger.error('updateRole error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getAllRoles = async (req, res) => {
  try {
    ...
    req.logger.error('getAllRoles error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.deleteRole = async (req, res) => {
  try {
    ...
    req.logger.error('deleteRole error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getAllApplications = async (req, res) => {
  try {
    ...
    req.logger.error('getAllApplications error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getApplicationDetail = async (req, res) => {
  try {
    ...
    req.logger.error('getApplicationDetail error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.updateApplicationStatus = async (req, res) => {
  try {
    ...
    req.logger.error('updateApplicationStatus error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.assignApplicationToStage = async (req, res) => {
  try {
    ...
    req.logger.error('assignApplicationToStage error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.activateInterview = async (req, res) => {
  try {
    ...
    req.logger.error('activateInterview error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.bulkDownloadDocuments = async (req, res) => {
  try {
    ...
    req.logger.error('bulkDownloadDocuments error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.createQuestion = async (req, res) => {
  try {
    ...
    req.logger.error('createQuestion error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getAllQuestions = async (req, res) => {
  try {
    ...
    req.logger.error('getAllQuestions error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.updateQuestion = async (req, res) => {
  try {
    ...
    req.logger.error('updateQuestion error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.deleteQuestion = async (req, res) => {
  try {
    ...
    req.logger.error('deleteQuestion error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getRecruitmentStats = async (req, res) => {
  try {
    ...
    req.logger.error('getRecruitmentStats error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.exportApplicationsPDF = async (req, res) => {
  try {
    ...
    req.logger.error('exportApplicationsPDF error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.exportApplicationsCSV = async (req, res) => {
  try {
    ...
    req.logger.error('exportApplicationsCSV error:', err);
    res.status(500).json({ success: false, message: 'Server error' });
  }
};
...
exports.getRecruitmentStatus = async (_req, res) => {
  try {
    ...
    req.logger.error('getRecruitmentStatus error:', error);
...
exports.toggleRecruitment = async (req, res) => {
  try {
    ...
    req.logger.error('toggleRecruitment error:', error);
...
exports.createApplication = async (req, res) => {
  try {
    ...
    req.logger.error('createApplication error:', error);
...
exports.initiatePayment = async (req, res) => {
  try {
    ...
    req.logger.error('initiatePayment error:', error.response?.data || error.message);
...
exports.paystackWebhook = async (req, res) => {
  try {
    ...
    if (!isWebhookIpAllowed(clientIp)) {
      req.logger.warn(`Blocked recruitment Paystack webhook from non-allowlisted IP: ${clientIp}`);
...
const setApplicantStatus = async (req, res, status) => {
  try {
    ...
    req.logger.error(`setApplicantStatus ${status} error:`, error);
...
exports.bulkProcessApplicants = async (req, res) => {
  try {
    ...
    req.logger.error('bulkProcessApplicants error:', error);
...
exports.toggleLocation = async (req, res) => {
  try {
    ...
    req.logger.error('toggleLocation error:', error);
...
exports.getLocationActivations = async (req, res) => {
  try {
    ...
    req.logger.error('getLocationActivations error:', error);
...
exports.bulkActivateLocations = async (req, res) => {
  try {
    ...
    req.logger.error('bulkActivateLocations error:', error);
...
exports.setInterviewDate = async (req, res) => {
  try {
    ...
    req.logger.error('setInterviewDate error:', error);
    ...
    for (const applicant of result.rows) {
      ...
      if (applicant.email_address) {
        sendEmail({
          ...
          html: emailHtml,
        }).catch((error) => req.logger.error('Interview email failed:', error.message));
      }
      ...
      if (applicant.phone_number) {
        ...
        sendSMS(applicant.phone_number, smsMessage)
          .catch((error) => req.logger.error('Interview SMS failed:', error.message));
      }
      ...
      try {
        ...
        req.logger.error('Interview notification error:', notifErr.message);
      }
    }

    res.json({ success: true, data: { updated: result.rowCount }, message: `${result.rowCount} interviews activated` });
  } catch (error) {
    req.logger.error('triggerInterview error:', error);
...
exports.generateApplicantPdf = async (req, res) => {
  try {
    ...
    req.logger.error('generateApplicantPdf error:', error);
...
exports.downloadApplicationDocs = async (req, res) => {
  try {
    ...
    req.logger.error('downloadApplicationDocs error:', error);
    if (!res.headersSent) res.status(500).json({ success: false, message: 'Failed to download documents' });
  }
};
...
exports.bulkDownloadDocs = async (req, res) => {
  try {
    ...
    req.logger.error('bulkDownloadDocs error:', error);
    if (!res.headersSent) res.status(500).json({ success: false, message: 'Failed to download documents' });
  }
};
  ...
  try {
    ...
    const safeQuery = async (sql, p) => {
      try {
        ...
        req.logger.error('Analytics sub-query error:', err.message);
        return { rows: [] };
      }
    };
    ...
    req.logger.error('getAnalytics error:', error);
...
exports.emailDocuments = async (req, res) => {
  try {
    ...
    req.logger.error('emailDocuments error:', error);
...
exports.bulkUploadQuestions = async (req, res) => {
  try {
    ...
    req.logger.error('bulkUploadQuestions error:', error);
