...
exports.getSubscriptionQuote = async (req, res) => {
  try {
    ...
    req.logger.error('Subscription quote error:', error);
...
exports.initializeSubscription = async (req, res) => {
  ...
  try {
    ...
    req.logger.error("Subscription initialization error:", error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.verifySubscription = async (req, res) => {
  try {
    ...
    req.logger.error("Subscription verification error:", error);
    res.status(500).json({
      success: false,
...
exports.initializePropertyUnlock = async (req, res) => {
  try {
    ...
    req.logger.error("Property unlock initialization error:", error);
    res.status(500).json({
      success: false,
...
exports.verifyPropertyUnlock = async (req, res) => {
  try {
    ...
    req.logger.error("Property unlock verification error:", error);
    res.status(500).json({
      success: false,
...
exports.getPropertyUnlockStatus = async (req, res) => {
  try {
    ...
    req.logger.error("Property unlock status error:", error);
    res.status(500).json({
      success: false,
...
exports.getMyUnlockedProperties = async (req, res) => {
  try {
    ...
    req.logger.error('Get my unlocked properties error:', error);
    res.status(500).json({
      success: false,
...
exports.getPropertyInspectionOptions = async (req, res) => {
  try {
    ...
    req.logger.error('Property inspection options error:', error);
...
exports.initializePropertyInspectionPayment = async (req, res) => {
  try {
    ...
    req.logger.error('Property inspection initialization error:', error);
    return res.status(500).json({
      success: false,
...
exports.verifyPropertyInspectionPayment = async (req, res) => {
  try {
    ...
    req.logger.error('Property inspection verification error:', error);
    return res.status(500).json({
      success: false,
...
exports.getTenantLocationAccessQuote = async (req, res) => {
  try {
    ...
    req.logger.error('Tenant location access quote error:', error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.initializeTenantLocationAccess = async (req, res) => {
  try {
    ...
    req.logger.error('Initialize tenant location access error:', error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.verifyTenantLocationAccess = async (req, res) => {
  try {
    ...
    req.logger.error('Verify tenant location access error:', error);
    res.status(500).json({
      success: false,
  ...
  try {
    ...
    if (transactionStarted) {
      try {
        ...
        req.logger.error('Lawyer directory unlock rollback error:', rollbackError);
      }
    }
    req.logger.error('Lawyer directory unlock initialization error:', error);
    return res.status(500).json({
      success: false,
...
exports.verifyLawyerDirectoryUnlock = async (req, res) => {
  try {
    ...
    req.logger.error('Lawyer directory unlock verification error:', error);
    return res.status(500).json({
      success: false,
...
exports.getLawyerDirectoryUnlockStatus = async (req, res) => {
  try {
    ...
    req.logger.error('Lawyer directory unlock status error:', error);
    return res.status(500).json({
      success: false,
...
exports.initializeListingPayment = async (req, res) => {
  try {
    ...
    req.logger.error("Listing payment initialization error:", error);
    res.status(500).json({
      success: false,
...
exports.verifyListingPayment = async (req, res) => {
 ...
 // Calculate commission for listing
    ...
    req.logger.error("Listing payment verification error:", error);
    res.status(500).json({
      success: false,
...
exports.initializeRentPayment = async (req, res) => {
  try {
    ...
    req.logger.error("Rent payment initialization error:", error);
    res.status(500).json({
      success: false,
...
exports.verifyRentPayment = async (req, res) => {
  try {
    ...
    req.logger.error("Rent payment verification error:", error);
    res.status(500).json({
      success: false,
...
exports.initializeWalletFunding = async (req, res) => {
  try {
    ...
    req.logger.error('Initialize wallet funding error:', error);
    res.status(500).json({
      success: false,
...
exports.verifyWalletFunding = async (req, res) => {
  try {
    ...
    req.logger.error('Verify wallet funding error:', error);
    res.status(500).json({
      success: false,
...
exports.retryPayment = async (req, res) => {
  try {
    ...
    req.logger.error("Retry payment error:", error);
    res.status(500).json({
      success: false,
...
exports.getBanks = async (_req, res) => {
  try {
    ...
    req.logger.error('Get banks error:', error);
    return res.status(500).json({
      success: false,
...
exports.refreshBankCache = async (_req, res) => {
  try {
    ...
    req.logger.error('Refresh bank cache error:', error);
    return res.status(500).json({
      success: false,
...
exports.verifyBankAccount = async (req, res) => {
  try {
    ...
    req.logger.error('Bank account verification error:', error);
