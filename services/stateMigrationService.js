...
exports.createMyMigrationRequest = async (req, res) => {
  try {
    ...
    req.logger.error('Create migration request error:', error);
...
exports.getMyMigrationRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Get my migration requests error:', error);
    return res.status(500).json({
      success: false,
...
exports.listSupportQueue = async (req, res) => {
  try {
    ...
    req.logger.error('List support migration queue error:', error);
    return res.status(500).json({
      success: false,
      message: 'Failed to fetch migration requests',
    });
...
exports.reviewMigrationByDirection = async (req, res) => {
  ...
  try {
    ...
    req.logger.error('Directional support review error:', error);
    return res.status(500).json({
      success: false,
...
exports.superSupportFinalReview = async (req, res) => {
  ...
  try {
    ...
    req.logger.error('Super support migration review error:', error);
    return res.status(500).json({
      success: false,
      message: 'Failed to review migration request',
    });
...
exports.getMigrationAuditLogs = async (req, res) => {
  try {
    ...
    req.logger.error('Get migration audit logs error:', error);
    return res.status(500).json({
      success: false,
