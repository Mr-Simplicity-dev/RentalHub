...
exports.adminReviewRelocationRefund = async (req, res) => {
  try {
    ...
    req.logger.error('Admin review relocation refund error:', error);
    res.status(500).json({
      success: false,
...
exports.submitRefundRequest = async (req, res) => {
  try {
    ...
    req.logger.error('Submit refund request error:', error);
    res.status(500).json({
      success: false,
...
exports.getTenantRefundRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Get tenant refund requests error:', error);
    res.status(500).json({
      success: false,
...
exports.getEligibleRentPayments = async (req, res) => {
  try {
    ...
    req.logger.error('Get eligible rent payments error:', error);
    res.status(500).json({
      success: false,
...
exports.getLandlordRefundRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Get landlord refund requests error:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to fetch refund requests',
    });
  ...
  try {
    ...
    if (refund.transaction_reference && PAYSTACK_SECRET_KEY) {
      try {
        ...
        req.logger.error('Paystack refund error:', paystackErr.response?.data || paystackErr.message);
      }
    }
    ...
    req.logger.error('Approve refund error:', error);
    res.status(500).json({
      success: false,
...
exports.rejectRefundRequest = async (req, res) => {
  try {
    ...
    req.logger.error('Reject refund error:', error);
    res.status(500).json({
      success: false,
...
exports.adminGetAllRefundRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Admin get refund requests error:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to fetch refund requests',
    });
...
exports.getEligibleGracePeriodPayments = async (req, res) => {
  try {
    ...
    req.logger.error('Get eligible grace payments error:', error);
    res.status(500).json({
      success: false,
...
exports.submitGracePeriodRequest = async (req, res) => {
  try {
    ...
    req.logger.error('Submit grace period request error:', error);
    res.status(500).json({
      success: false,
...
exports.getTenantGracePeriodRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Get tenant grace requests error:', error);
    res.status(500).json({
      success: false,
...
exports.getLandlordGracePeriodRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Get landlord grace period requests error:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to fetch grace period requests',
    });
...
exports.respondGracePeriodRequest = async (req, res) => {
  try {
    ...
    req.logger.error('Respond grace period request error:', error);
    res.status(500).json({
      success: false,
...
exports.adminGetTenancyAdjustmentRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Admin get tenancy adjustment requests error:', error);
    res.status(500).json({
      success: false,
...
exports.adminReviewTenancyAdjustmentRequest = async (req, res) => {
  try {
    ...
    req.logger.error('Admin review tenancy adjustment request error:', error);
    res.status(500).json({
      success: false,
...
exports.getWalletBalance = async (req, res) => {
  try {
    ...
    req.logger.error('Get wallet balance error:', error);
...
exports.getMyWithdrawals = async (req, res) => {
  try {
    ...
    req.logger.error('Get withdrawals error:', error);
...
exports.getPendingWalletWithdrawals = async (req, res) => {
  try {
    ...
    req.logger.error('Get pending wallet withdrawals error:', error);
...
exports.approveWalletWithdrawal = async (req, res) => {
  try {
    ...
    req.logger.error('Approve wallet withdrawal error:', error);
...
exports.rejectWalletWithdrawal = async (req, res) => {
  try {
    ...
    req.logger.error('Reject wallet withdrawal error:', error);
...
exports.getLandlordWalletBalance = async (req, res) => {
  try {
    ...
    req.logger.error('Get landlord wallet error:', error);
    res.status(500).json({ success: false, message: 'Failed to fetch wallet balance' });
  }
};
