...
exports.initializeVerificationPayment = async (req, res) => {
  try {
    ...
    req.logger.error('Evidence verification payment error:', error);
...
exports.verifyDispute = async (req, res) => {
  try {
    ...
    req.logger.error('Verification error:', error);
...
exports.adminGetVerificationLogs = async (req, res) => {
  try {
    ...
    req.logger.error('Admin evidence verification logs error:', error);
    return res.status(500).json({
      success: false,
