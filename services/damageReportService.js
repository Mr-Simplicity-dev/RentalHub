...
class DamageReportController {
  ...
  static async getPropertyReports(req, res) {
    try {
      ...
      req.logger.error(`Error fetching property reports: ${error.message}`);
      res.status(500).json({
        success: false,
  ...
  static async publishReport(req, res) {
    try {
      ...
      req.logger.error(`Error publishing report: ${error.message}`);
      res.status(400).json({
        success: false,
  ...
  static async unpublishReport(req, res) {
    try {
      ...
      req.logger.error(`Error unpublishing report: ${error.message}`);
      res.status(400).json({
        success: false,
  ...
  static async updateReport(req, res) {
    try {
      ...
      req.logger.error(`Error updating report: ${error.message}`);
      res.status(400).json({
        success: false,
  ...
  static async deleteReport(req, res) {
    try {
      ...
      req.logger.error(`Error deleting report: ${error.message}`);
      res.status(400).json({
        success: false,
  ...
  static async getReportSummary(req, res) {
    try {
      ...
      req.logger.error(`Error fetching report summary: ${error.message}`);
      res.status(500).json({
        success: false,
