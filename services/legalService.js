...
exports.getPublicLawyerDirectory = async (_req, res) => {
  try {
    ...
    req.logger.error('Get public lawyer directory error:', error);
...
exports.getUnlockedLawyerDirectory = async (req, res) => {
  try {
    ...
    req.logger.error('Get unlocked lawyer directory error:', error);
    return res.status(500).json({
      success: false,
...
exports.getPlatformLawyerProgram = async (req, res) => {
  try {
    ...
    req.logger.error('Get platform lawyer program error:', error);
    return res.status(500).json({
      success: false,
...
exports.applyToPlatformLawyerProgram = async (req, res) => {
  try {
    ...
    req.logger.error('Apply to platform lawyer program error:', error);
    return res.status(500).json({
      success: false,
...
exports.grantLawyerAccess = async (req, res) => {
  try {
    ...
    req.logger.error("Grant lawyer access error:", error);
...
exports.getAuthorizedProperties = async (req, res) => {
  ...
  try {
    ...
    req.logger.error("Get authorized properties error:", error);
...
exports.resolveDispute = async (req, res) => {
  ...
  try {
    ...
    req.logger.error("Resolve dispute error:", error);
...
exports.getLegalAuditLogs = async (req, res) => {
  try {
    ...
    req.logger.error('Get legal audit logs error:', error);
    return res.status(500).json({
      success: false,
...
exports.verifyEvidence = async (req, res) => {
  try {
    ...
    req.logger.error('Verify evidence error:', error);
    return res.status(500).json({
      success: false,
...
exports.getEvidenceVerification = async (req, res) => {
  try {
    ...
    req.logger.error('Get evidence verification error:', error);
    return res.status(500).json({
      success: false,
...
exports.createCaseNote = async (req, res) => {
  try {
    ...
    req.logger.error('Create case note error:', error);
    return res.status(500).json({
      success: false,
...
exports.getCaseNotes = async (req, res) => {
  try {
    ...
    req.logger.error('Get case notes error:', error);
    return res.status(500).json({
      success: false,
...
exports.updateCaseNote = async (req, res) => {
  try {
    ...
    req.logger.error('Update case note error:', error);
    return res.status(500).json({
      success: false,
...
exports.deleteCaseNote = async (req, res) => {
  try {
    ...
    req.logger.error('Delete case note error:', error);
    return res.status(500).json({
      success: false,
...
exports.updateDisputeSummary = async (req, res) => {
  try {
    ...
    req.logger.error('Update dispute summary error:', error);
    return res.status(500).json({
      success: false,
...
exports.getCoverageStatus = async (req, res) => {
  try {
    ...
    req.logger.error('Get coverage status error:', error);
    return res.status(500).json({
      success: false,
...
exports.getMySupportRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Get support requests error:', error);
    return res.status(500).json({
      success: false,
  ...
  try {
    ...
    if (assignedLawyerId) {
      try {
        ...
        req.logger.error('Legal request notification error:', notifErr);
      }
    }
    ...
    req.logger.error('Submit support request error:', error);
    return res.status(500).json({
      success: false,
