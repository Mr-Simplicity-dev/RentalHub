...
exports.getSetupFees = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching setup fees:', error);
...
exports.createPlan = async (req, res) => {
  ...
  try {
    ...
    await client.query('ROLLBACK');
    req.logger.error('Error creating savings plan:', error);
...
exports.getMyPlans = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching savings plans:', error);
...
exports.getPlanDetails = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching plan details:', error);
...
exports.togglePlan = async (req, res) => {
  try {
    ...
    req.logger.error('Error toggling plan:', error);
...
exports.makeContribution = async (req, res) => {
  ...
  try {
    ...
    await client.query('ROLLBACK');
    req.logger.error('Error making contribution:', error);
...
exports.getPlanContributions = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching contributions:', error);
...
exports.getMissedMonths = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching missed months:', error);
...
exports.withdrawAtMaturity = async (req, res) => {
  ...
  try {
    ...
    await client.query('ROLLBACK');
    req.logger.error('Error withdrawing at maturity:', error);
...
exports.requestEarlyWithdrawal = async (req, res) => {
  ...
  try {
    ...
    await client.query('ROLLBACK');
    req.logger.error('Error requesting early withdrawal:', error);
...
exports.getMyEarlyWithdrawalRequests = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching early withdrawal requests:', error);
...
exports.getMySavingsSummary = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching savings summary:', error);
...
exports.adminGetAllPlans = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching all plans:', error);
...
exports.adminApproveEarlyWithdrawal = async (req, res) => {
  ...
  try {
    ...
    await client.query('ROLLBACK');
    req.logger.error('Error approving early withdrawal:', error);
...
exports.adminRejectEarlyWithdrawal = async (req, res) => {
  try {
    ...
    req.logger.error('Error rejecting early withdrawal:', error);
...
exports.adminCreateSetupFee = async (req, res) => {
  try {
    ...
    req.logger.error('Error creating/updating setup fee:', error);
...
exports.adminDeleteSetupFee = async (req, res) => {
  try {
    ...
    req.logger.error('Error deleting setup fee:', error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.adminGetRevenueLedger = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching revenue ledger:', error);
...
exports.adminGetStats = async (req, res) => {
  try {
    ...
    req.logger.error('Error fetching admin stats:', error);
...
exports.adminCancelPlan = async (req, res) => {
  try {
    ...
    req.logger.error('Error cancelling plan:', error);
