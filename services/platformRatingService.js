...
const runOpportunityQuery = async (sql, params) => {
  try {
    ...
    req.logger.warn('Platform rating opportunity query skipped:', error.message);
    return [];
  }
};
...
exports.getOpportunities = async (req, res) => {
  try {
    ...
    req.logger.error('Get rating opportunities error:', error);
...
exports.submitRating = async (req, res) => {
  try {
    ...
    req.logger.error('Submit platform rating error:', error);
...
exports.getPublicRatings = async (req, res) => {
  try {
    ...
    req.logger.error('Get public ratings error:', error);
...
exports.adminListRatings = async (req, res) => {
  try {
    ...
    req.logger.error('Admin list platform ratings error:', error);
...
exports.adminUpdateSettings = async (req, res) => {
  try {
    ...
    req.logger.error('Update platform rating settings error:', error);
...
exports.adminModerateRating = async (req, res) => {
  try {
    ...
    req.logger.error('Moderate platform rating error:', error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.adminCreateRule = async (req, res) => {
  try {
    ...
    req.logger.error('Create platform rating rule error:', error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.adminUpdateRule = async (req, res) => {
  try {
    ...
    req.logger.error('Update platform rating rule error:', error);
    res.status(error.statusCode || 500).json({
      success: false,
...
exports.adminDeleteRule = async (req, res) => {
  try {
    ...
    req.logger.error('Delete platform rating rule error:', error);
    res.status(error.statusCode || 500).json({
      success: false,
