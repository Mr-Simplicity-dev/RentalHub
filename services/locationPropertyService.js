...
exports.getPropertiesByState = async (req, res) => {
  try {
    ...
    req.logger.error('Get properties by state error:', error);
    res.status(500).json({
      success: false,
...
exports.getStateStatistics = async (req, res) => {
  try {
    ...
    req.logger.error('Get state statistics error:', error);
    res.status(500).json({
      success: false,
...
exports.getCitiesByState = async (req, res) => {
  try {
    ...
    req.logger.error('Get cities by state error:', error);
    res.status(500).json({
      success: false,
...
exports.getPropertyTypesByState = async (req, res) => {
  try {
    ...
    req.logger.error('Get property types by state error:', error);
    res.status(500).json({
      success: false,
...
exports.getRentalPriceDistribution = async (req, res) => {
  try {
    ...
    req.logger.error('Get rental price distribution error:', error);
    res.status(500).json({
      success: false,
...
exports.getStateAdminPerformance = async (req, res) => {
  try {
    ...
    req.logger.error('Get state admin performance error:', error);
    res.status(500).json({
      success: false,
