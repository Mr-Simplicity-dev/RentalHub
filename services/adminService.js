...
exports.getStats = async (req, res) => {
  try {
    ...
    req.logger.error('Admin stats error:', err);
    res.status(500).json({
      success: false,
...
exports.getAllUsers = async (req, res) => {
  try {
    ...
    req.logger.error('Admin users error:', err);
    res.status(500).json({
      success: false,
...
exports.getPendingVerifications = async (req, res) => {
  try {
    ...
    req.logger.error('Pending verifications error:', err);
...
exports.approveVerification = async (req, res) => {
  try {
    ...
    req.logger.error('Approve verification error:', err);
...
exports.rejectVerification = async (req, res) => {
  try {
    ...
    req.logger.error('Reject verification error:', err);
...
exports.getAllProperties = async (req, res) => {
  try {
    ...
    req.logger.error('Admin properties error:', err);
    res.status(500).json({
      success: false,
...
exports.getPendingProperties = async (req, res) => {
  try {
    ...
    req.logger.error('Pending properties error:', err);
    res.status(500).json({
      success: false,
  ...
  try {
    ...
    if (landlordResult.rows.length) {
      ...
      try {
        ...
        req.logger.error('Failed to send approval email:', mailError.message);
      }
    }

    notifyAlertsForProperty(property).catch((err) => {
      req.logger.error('Tenant alert notification failed:', err);
    });
    ...
    req.logger.error('Approve property error:', err);
    res.status(500).json({
      success: false,
...
const landlord = await db.query(
  ...
  [property.landlord_id]
    ...
    req.logger.error('Reject property error:', err);
    res.status(500).json({
      success: false,
...
exports.getAllApplications = async (req, res) => {
  try {
    ...
    req.logger.error('Admin applications error:', err);
    res.status(500).json({
      success: false,
...
exports.deleteUser = async (req, res) => {
  try {
    ...
    req.logger.error('Soft delete user error:', err);
...
exports.verifyUser = async (req, res) => {
  try {
    ...
    req.logger.error('Manual verify user error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
...
exports.assignAgentToLandlord = async (req, res) => {
  try {
    ...
    req.logger.error('Assign agent to landlord error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
...
exports.approveApplication = async (req, res) => {
  try {
    ...
    req.logger.error('Approve application error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
...
exports.rejectApplication = async (req, res) => {
  try {
    ...
    req.logger.error('Reject application error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
  ...
  try {
    ...
    if (stateBoundRoles.has(user_type)) {
      ...
      try {
        ...
        req.logger.warn('Create admin state lookup failed, using fallback states:', stateLookupError.message);
      }
...
exports.unlistProperty = async (req, res) => {
  try {
    ...
    req.logger.error('Admin unlist property error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
...
exports.relistProperty = async (req, res) => {
  try {
    ...
    req.logger.error('Admin relist property error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
...
exports.featureProperty = async (req, res) => {
  try {
    ...
    req.logger.error('Admin feature property error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
...
exports.unfeatureProperty = async (req, res) => {
  try {
    ...
    req.logger.error('Admin unfeature property error:', err);
    res.status(err.statusCode || 500).json({
      success: false,
