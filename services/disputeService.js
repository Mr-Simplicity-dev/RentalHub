...
exports.createDispute = async (req, res) => {
  try {
    ...
    req.logger.error('Create dispute error:', error);
    res.status(500).json({
      success: false,
...
exports.getDisputes = async (req, res) => {
  try {
    ...
    req.logger.error('Get disputes error:', error);
    res.status(500).json({
      success: false,
...
exports.getDisputeDetails = async (req, res) => {
  try {
    ...
    req.logger.error('Get dispute details error:', error);
...
exports.listDisputeEvidence = async (req, res) => {
  try {
    ...
    req.logger.error('List dispute evidence error:', error);
    return res.status(500).json({
      success: false,
...
exports.addDisputeMessage = async (req, res) => {
  try {
    ...
    req.logger.error('Add dispute message error:', error);
    res.status(500).json({
      success: false,
...
exports.editDisputeMessage = async (req, res) => {
  try {
    ...
    req.logger.error('Edit dispute message error:', error);
    res.status(500).json({
      success: false,
...
exports.getMyDisputes = async (req, res) => {
  try {
    ...
    req.logger.error('Get my disputes error:', error);
    res.status(500).json({
      success: false,
      message: 'Failed to fetch disputes'
    });
...
exports.uploadEvidence = async (req, res) => {
  try {
    ...
    req.logger.error('Evidence upload error:', error);
...
exports.verifyEvidenceIntegrity = async (req, res) => {
  try {
    ...
    req.logger.error('Integrity check error:', error);
    res.status(500).json({
      success: false,
    ...
    if (dispute.status !== 'resolved') {
      return res.status(400).json({
        ...
        await anchorEvidence(disputeId, merkleRoot);
            ...
            req.logger.error('Seal dispute error:', error);
