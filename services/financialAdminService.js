...
exports.getAllTransactions = async (req, res) => {
  try {
    ...
    req.logger.error('Get all transactions error:', error);
    res.status(500).json({
      success: false,
...
exports.freezeUserFunds = async (req, res) => {
  try {
    ...
    req.logger.error('Freeze funds error:', error);
    res.status(500).json({
      success: false,
...
exports.getFrozenFunds = async (req, res) => {
  try {
    ...
    req.logger.error('Get frozen funds error:', error);
    res.status(500).json({
      success: false,
...
exports.getTransactionAuditTrail = async (req, res) => {
  try {
    ...
    req.logger.error('Get transaction audit trail error:', error);
    res.status(500).json({
      success: false,
...
exports.getRealTimeStats = async (req, res) => {
  try {
    ...
    req.logger.error('Get real-time stats error:', error);
    res.status(500).json({
      success: false,
