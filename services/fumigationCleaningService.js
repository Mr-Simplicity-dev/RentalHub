...
class FumigationCleaningController {
  ...
  async getServiceCategories(req, res) {
    try {
      ...
      req.logger.error('Error getting service categories:', error);
      res.status(500).json({
        success: false,
  ...
  async getAllServices(req, res) {
    try {
      ...
      req.logger.error('Error getting services:', error);
      res.status(500).json({
        success: false,
  ...
  async calculateServicePrice(req, res) {
    try {
      ...
      req.logger.error('Error calculating service price:', error);
      res.status(500).json({
        success: false,
  ...
  async getAvailableBookingDates(req, res) {
    try {
      ...
      req.logger.error('Error getting available dates:', error);
      res.status(500).json({
        success: false,
  ...
  async createBooking(req, res) {
    try {
      ...
      try {
        ...
        req.logger.error('Failed to send notification:', notificationError);
  ...
  async cancelBooking(req, res) {
    try {
      ...
      try {
        ...
        req.logger.error('Failed to send cancellation notification:', notificationError);
      }
  ...
  async initializeBookingPayment(req, res) {
    try {
      ...
      req.logger.error('Error initializing payment:', error);
      res.status(500).json({
        success: false,
  ...
  async verifyPayment(req, res) {
    try {
      ...
      try {
        ...
        req.logger.error('Failed to send payment notification:', notificationError);
      }
      ...
      req.logger.error('Error verifying payment:', error);
      res.status(500).json({
        success: false,
  ...
  async getTenantStats(req, res) {
    try {
      ...
      req.logger.error('Error getting tenant stats:', error);
      res.status(500).json({
        success: false,
  ...
  async submitReview(req, res) {
    try {
      ...
      req.logger.error('Error submitting review:', error);
      res.status(500).json({
        success: false,
  ...
  async getServiceReviews(req, res) {
    try {
      ...
      req.logger.error('Error getting service reviews:', error);
      res.status(500).json({
        success: false,
  ...
  async getAllBookings(req, res) {
    try {
      ...
      req.logger.error('Error getting all bookings:', error);
      res.status(500).json({
        success: false,
        message: 'Failed to retrieve bookings',
        error: error.message
  ...
  async getAdminStats(req, res) {
    try {
      ...
      req.logger.error('Error getting admin stats:', error);
      res.status(500).json({
        success: false,
  ...
  async updateBookingStatus(req, res) {
    try {
      ...
      try {
        ...
        req.logger.error('Failed to write fumigation status operation:', operationError);
      }
      ...
      try {
        ...
        req.logger.error('Failed to send status update notification:', notificationError);
      }
      ...
      req.logger.error('Error updating booking status:', error);
      res.status(500).json({
        success: false,
  ...
  async assignProvider(req, res) {
    try {
      ...
      try {
        ...
        req.logger.error('Failed to write fumigation assignment operation:', operationError);
      }
      ...
      try {
        ...
        req.logger.error('Failed to send provider assignment notification:', notificationError);
      }
      ...
      req.logger.error('Error assigning provider:', error);
      res.status(500).json({
        success: false,
  ...
  async getBookingOperations(req, res) {
    try {
      ...
      req.logger.error('Error getting booking operations:', error);
      res.status(500).json({
        success: false,
  ...
  async updateProviderLifecycle(req, res) {
    try {
      ...
      try {
        ...
        req.logger.error('Failed to send provider lifecycle notification:', notificationError);
      }
      ...
      req.logger.error('Error updating provider operation:', error);
      res.status(500).json({
        success: false,
  ...
  async getAvailableProvidersForBooking(req, res) {
    try {
      ...
      req.logger.error('Error getting available providers:', error);
      res.status(500).json({
        success: false,
  ...
  async getProviders(req, res) {
    try {
      ...
      req.logger.error('Error getting providers:', error);
      res.status(500).json({
        success: false,
  ...
  async getProviderById(req, res) {
    try {
      ...
      req.logger.error('Error getting provider by ID:', error);
      res.status(500).json({
        success: false,
  ...
  async submitSafetyCompliance(req, res) {
    try {
      ...
      req.logger.error('Error submitting safety compliance:', error);
      res.status(500).json({
        success: false,
  ...
  async getComplianceRecord(req, res) {
    try {
      ...
      req.logger.error('Error getting compliance record:', error);
      res.status(500).json({
        success: false,
