...
const listSubscribers = async (req, res) => {
  try {
    ...
    req.logger.error('List SMS subscribers error:', error.message);
...
const addSubscriber = async (req, res) => {
  try {
    ...
    req.logger.error('Add SMS subscriber error:', error.message);
...
const updateSubscriber = async (req, res) => {
  try {
    ...
    req.logger.error('Update SMS subscriber error:', error.message);
...
const deleteSubscriber = async (req, res) => {
  try {
    ...
    req.logger.error('Delete SMS subscriber error:', error.message);
...
const listTemplates = async (req, res) => {
  try {
    ...
    req.logger.error('List SMS templates error:', error.message);
...
const createTemplate = async (req, res) => {
  try {
    ...
    req.logger.error('Create SMS template error:', error.message);
...
const updateTemplate = async (req, res) => {
  try {
    ...
    req.logger.error('Update SMS template error:', error.message);
...
const deleteTemplate = async (req, res) => {
  try {
    ...
    req.logger.error('Delete SMS template error:', error.message);
...
const listCampaigns = async (req, res) => {
  try {
    ...
    req.logger.error('List SMS campaigns error:', error.message);
...
const createCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Create SMS campaign error:', error.message);
...
const updateCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Update SMS campaign error:', error.message);
...
const deleteCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Delete SMS campaign error:', error.message);
...
const getDashboardStats = async (req, res) => {
  try {
    ...
    req.logger.error('SMS marketing stats error:', error.message);
...
const importSubscribers = async (req, res) => {
  try {
    ...
    req.logger.error('Import SMS subscribers error:', error.message);
...
const sendCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Send SMS campaign error:', error.message);
...
const retryCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Retry SMS campaign error:', error.message);
...
const getCampaignStats = async (req, res) => {
  try {
    ...
    req.logger.error('SMS campaign stats error:', error.message);
