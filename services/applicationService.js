...
exports.submitApplication = async (req, res) => {
  try {
    ...
    req.logger.error('Submit application error:', error);
...
exports.getMyApplications = async (req, res) => {
  try {
    ...
    req.logger.error('Get my applications error:', error);
...
exports.getReceivedApplications = async (req, res) => {
  try {
    ...
    req.logger.error('Get received applications error:', error);
    return res.status(500).json({ success: false, message: 'Failed to fetch applications' });
  }
};
...
exports.landlordAcceptOffer = async (req, res) => {
  try {
    ...
    req.logger.error('Landlord accept offer error:', error);
...
exports.landlordCounterOffer = async (req, res) => {
  try {
    ...
    req.logger.error('Landlord counter offer error:', error);
...
exports.tenantUpdateOffer = async (req, res) => {
  try {
    ...
    req.logger.error('Tenant update offer error:', error);
...
exports.tenantRespondToCounter = async (req, res) => {
  try {
    ...
    req.logger.error('Tenant respond to counter error:', error);
...
exports.rejectApplication = async (req, res) => {
  try {
    ...
    req.logger.error('Reject application error:', error);
