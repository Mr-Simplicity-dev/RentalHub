...
const listSubscribers = async (req, res) => {
  try {
    ...
    req.logger.error('List subscribers error:', error.message);
...
const addSubscriber = async (req, res) => {
  try {
    ...
    req.logger.error('Add subscriber error:', error.message);
...
const updateSubscriber = async (req, res) => {
  try {
    ...
    req.logger.error('Update subscriber error:', error.message);
...
const deleteSubscriber = async (req, res) => {
  try {
    ...
    req.logger.error('Delete subscriber error:', error.message);
...
const unsubscribe = async (req, res) => {
  try {
    ...
    req.logger.error('Unsubscribe error:', error.message);
...
const listTemplates = async (req, res) => {
  try {
    ...
    req.logger.error('List templates error:', error.message);
...
const createTemplate = async (req, res) => {
  try {
    ...
    req.logger.error('Create template error:', error.message);
...
const updateTemplate = async (req, res) => {
  try {
    ...
    req.logger.error('Update template error:', error.message);
...
const deleteTemplate = async (req, res) => {
  try {
    ...
    req.logger.error('Delete template error:', error.message);
...
const listCampaigns = async (req, res) => {
  try {
    ...
    req.logger.error('List campaigns error:', error.message);
...
const createCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Create campaign error:', error.message);
...
const updateCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Update campaign error:', error.message);
...
const deleteCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Delete campaign error:', error.message);
...
const sendCampaign = async (req, res) => {
  try {
    ...
    req.logger.error('Send campaign error:', error.message);
...
const getCampaignStats = async (req, res) => {
  try {
    ...
    req.logger.error('Campaign stats error:', error.message);
...
const getDashboardStats = async (req, res) => {
  try {
    ...
    req.logger.error('Email marketing stats error:', error.message);
