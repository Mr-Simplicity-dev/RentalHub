...
exports.createRequest = async (req, res) => {
  ...
  try {
    ...
    console.error('Create credential revalidation request error:', error);
...
exports.listRequests = async (req, res) => {
  try {
    ...
    console.error('List credential revalidation requests error:', error);
...
exports.getMyRequests = async (req, res) => {
  try {
    ...
    console.error('Get user credential revalidation requests error:', error);
...
exports.reviewRequest = async (req, res) => {
  ...
  try {
    ...
    await rollbackQuietly(client);
    console.error('Review credential revalidation error:', error);
