...
exports.getStatus = async (req, res) => {
  try {
    ...
    console.error('Landlord property fee status error:', error);
    res.status(500).json({
      success: false,
...
exports.skipNotice = async (req, res) => {
  try {
    ...
    console.error('Landlord property fee skip error:', error);
...
exports.agreeAndSettle = async (req, res) => {
  try {
    ...
    console.error('Landlord property fee settle error:', error);
    let status = null;
    try {
