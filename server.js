...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", "res.cloudinary.com", "data:", "blob:", "js-eu1.hs-scripts.com", "www.googletagmanager.com"],
      connectSrc: ["'self'", "api.paystack.co", "api.hubspot.com", "forms.hubspot.com", "www.google-analytics.com", "www.googletagmanager.com"],
