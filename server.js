...
const tenancyAgreementRoutes = require('./routes/tenancyAgreements');
const tenancyAgreementTemplateRoutes = require('./routes/tenancyAgreementTemplates');
...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", "res.cloudinary.com", "data:", "blob:", "js-eu1.hs-scripts.com", "www.googletagmanager.com", "https://challenges.cloudflare.com", "https://static.cloudflareinsights.com"],
      connectSrc: ["'self'", "api.paystack.co", "api.hubspot.com", "forms.hubspot.com", "www.google-analytics.com", "www.googletagmanager.com", "https://challenges.cloudflare.com"],
      fontSrc: ["'self'", "fonts.googleapis.com", "fonts.gstatic.com"],
      styleSrc: ["'self'", "fonts.googleapis.com", "https://challenges.cloudflare.com"],
      mediaSrc: ["'self'", "res.cloudinary.com", "blob:"],
      frameSrc: ["'self'", "app.hubspot.com", "https://challenges.cloudflare.com"],
      frameAncestors: ["'none'"],
    },
  },
...
app.use('/api/tenancy-agreements', generalOpsLimiter, tenancyAgreementRoutes);
app.use('/api/tenancy-agreement-templates', adminLimiter, tenancyAgreementTemplateRoutes);
...
app.use('/api', generalOpsLimiter, require('./routes/rentStats'));
